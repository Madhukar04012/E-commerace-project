...
export default function Kitchen() {
  ...
  useEffect(() => {
    try {
      ...
      console.error("Error filtering kitchen products:", err);
    }
  }, []);
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <p className="text-gray-600">
          Upgrade your kitchen with our high-quality cookware and accessories.
          From stainless steel water bottles to glass food storage containers and coffee makers, find everything you need for your culinary adventures.
        </p>
      </div>
      ...
      {!loading && products.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            We're currently updating our kitchen selection. Check back soon!
          </p>
        </div>
      )}
    </div>
