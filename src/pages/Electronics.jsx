...
export default function Electronics() {
  ...
  useEffect(() => {
    try {
      ...
      console.error("Error filtering electronics products:", err);
    }
  }, []);
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <p className="text-gray-600">
          Discover the latest in technology with our premium selection of electronics. 
          From headphones and smartwatches to home security cameras and portable speakers.
        </p>
      </div>
      ...
      {!loading && products.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            We're currently updating our electronics selection. Check back soon!
          </p>
        </div>
      )}
    </div>
