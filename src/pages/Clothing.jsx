...
export default function Clothing() {
  ...
  useEffect(() => {
    try {
      ...
      console.error("Error filtering clothing products:", err);
    }
  }, []);
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <p className="text-gray-600">
          Discover our sustainable and stylish clothing collection.
          From organic cotton t-shirts to comfortable everyday wear, explore fashion that looks good and feels good.
        </p>
      </div>
      ...
      {!loading && products.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            We're currently updating our clothing selection. Check back soon!
          </p>
        </div>
      )}
    </div>
