...
export default function Accessories() {
  ...
  useEffect(() => {
    try {
      const accessoriesProducts = mockProducts.filter(
        (product) => product.category === "Accessories"
      );
      setProducts(accessoriesProducts);
    } catch (err) {
      console.error("Error filtering accessories products:", err);
    }
  }, []);
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <p className="text-gray-600">
          ...
          From leather wallets to stylish bags and more, find the perfect finishing touch for any outfit.
        </p>
      </div>
      ...
      {!loading && products.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            We're currently updating our accessories selection. Check back soon!
          </p>
        </div>
      )}
    </div>
